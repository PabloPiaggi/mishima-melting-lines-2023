...
step_size_pressure=-1000 # bar
num_steps=3
lammps_exe="/home/ppiaggi/Programs/Software-deepmd-kit-1.0/lammps-git4/src/lmp_mpi"
exe="mpirun -np 4 " + lammps_exe + " -sf omp -screen screen.txt -i "
...
def slope(my_pressure,my_temperature):
	...
	# Run two phases
	p1 = subprocess.Popen("cd phase1; " + exe + "in.lammps.phase1")
	p2 = subprocess.Popen("cd phase2; " + exe + "in.lammps.phase2")
	p1.wait()
	p2.wait()
	#os.system("cd phase1; " + exe + "phase1/in.lammps.phase1" + " &")
	#os.system("cd phase2; " + exe + "phase2/in.lammps.phase2" + " &")
	#os.system("wait")
